...
export const HomeNavbar = () => {
  return (
    <nav className='w-full flex  fixed top-0 items-center h-16 px-2   gap-x-3 bg-background z-50'>
      <section className='flex items-center gap-4 w-full '>
        ...
        <div className='flex flex-grow justify-end basis-0 items-center space-x-4 pr-2'>
          <AuthButton />
        </div>
      </section>
    </nav>
